...
export function ReaderPage({ chapterId }: { chapterId: string }) {
 ...
 <Link href="/manga" className="mt-4 inline-block text-hell-light">
 بازگشت به کتابخانه
 </Link>
 </Card>
 </main>
 ...
 className={readerMode === 'comfortable' ? 'rounded-2xl bg-hell-violet px-4 py-3 font-black' : 'rounded-2xl bg-white/[0.055] px-4 py-3 text-white/60'}
 >
 حالت راحت
 </button>
 ...
 className={readerMode === 'wide' ? 'rounded-2xl bg-hell-violet px-4 py-3 font-black' : 'rounded-2xl bg-white/[0.055] px-4 py-3 text-white/60'}
 >
 ...
 className={readerMode === 'focus' ? 'rounded-2xl bg-hell-violet px-4 py-3 font-black' : 'rounded-2xl bg-white/[0.055] px-4 py-3 text-white/60'}
 >
 ...
 <Reveal>
 <div>
 <div className="mb-4 flex items-center gap-2 text-hell-light">
 <Sparkles size={18} />
 ...
 <MessageCircle className="text-hell-light" />
 کامنت‌ها
 </h2>
 ...
 {showComments ? (
 <>
 <Card className="card mb-6 rounded-[2rem] p-5">
 {user ? (
 <div className="grid gap-0">
 <Textarea
 value={commentBody}
 ...
 <div className="rounded-3xl border border-hell-light/20 bg-hell-light/10 p-5">
 <div className="mb-2 flex items-center gap-2 text-hell-light">
 <ShieldAlert size={18} />
 ...
 {comment.spoiler ? (
 <Badge className="bg-hell-violet/15 text-red-100">اسپویلر</Badge>
 ) : null}
 </div>
