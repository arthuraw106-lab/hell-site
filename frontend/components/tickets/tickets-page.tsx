    ...
    <AppShell>
      <main className="mx-auto max-w-7xl px-5 py-10">
        <div className="mb-8 flex items-center gap-3">
          <div className="grid h-14 w-14 place-items-center rounded-3xl bg-hell-red shadow-glow">
            <LifeBuoy />
          </div>
          <div>
                ...
                <Card key={ticket.id} className="p-5">
                  ...
                  <div className="mt-4 grid gap-3">
                    {ticket.messages.map((message) => (
                      <div
                        key={message.id}
                        className={message.isAdmin ? 'rounded-2xl bg-hell-red/15 p-3' : 'rounded-2xl bg-white/[0.05] p-3'}
                      >
