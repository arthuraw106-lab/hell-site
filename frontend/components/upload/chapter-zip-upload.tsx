...
export function ChapterZipUpload({
  ...
  return (
    <div className="rounded-2xl border border-dashed border-hell-gold/30 bg-hell-gold/10 p-4 transition hover:bg-hell-gold/15">
      <label className="flex cursor-pointer flex-col items-center justify-center gap-3 text-center">
        {loading ? <Loader2 className="animate-spin text-hell-gold" /> : <Archive className="text-hell-gold" />}
      ...
      {lastCount !== null ? (
        <p className="mt-3 text-center text-sm font-bold text-hell-gold">
