...
export function UploadBox({
  ...
  return (
    <div className="rounded-2xl border border-dashed border-white/15 bg-white/[0.04] p-4 transition hover:border-hell-gold/35 hover:bg-white/[0.06]">
      <label className="flex cursor-pointer flex-col items-center justify-center gap-3 text-center">
        <UploadCloud className={loading ? 'animate-bounce text-hell-gold' : 'text-hell-gold'} />
