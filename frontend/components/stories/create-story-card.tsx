  ...
  if (!open) {
    return (
      <button
        ...
        className="group relative grid min-h-36 min-w-28 place-items-center overflow-hidden rounded-[2rem] border border-dashed border-hell-red/45 bg-hell-red/10 p-3 text-center transition hover:bg-hell-red/18"
      >
        <div className="absolute inset-0 bg-gradient-to-br from-hell-red/20 to-transparent opacity-0 transition group-hover:opacity-100" />
        <div className="relative z-10">
          <div className="mx-auto grid h-14 w-14 place-items-center rounded-full bg-gradient-to-br from-hell-red to-hell-violet shadow-glow transition group-hover:scale-110">
            <Film />
          </div>
