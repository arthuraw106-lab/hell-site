...
export function StoryViewer({
 ...
 return (
 <div className="fixed inset-0 z-[200] grid place-items-center bg-black/95 p-0 text-white ">
 ...
 <div className="absolute bottom-24 left-6 right-6 rounded-3xl bg-black/45 p-4 text-center leading-7 ">
 {story.text}
 </div>
 ) : null}
 ...
 type="button"
 onClick={like}
 className={liked[story.id] ? 'rounded-full bg-red-500 px-4 py-3 font-black text-white' : 'rounded-full bg-white/10 px-4 py-3 font-black text-white '}
 >
 ...
 className="rounded-full bg-red-500/80 px-4 py-3 font-black text-white disabled:opacity-50"
 >
 <Trash2 size={18} />
 </button>
 </div>
 ) : (
 <div className="rounded-full bg-white/10 px-4 py-2 text-sm text-white/65 ">
 ...
 {isOwner && panel !== 'none' ? (
 <div className="absolute bottom-24 left-5 right-5 z-30 max-h-80 overflow-y-auto rounded-[2rem] border border-white/10 bg-black/75 p-4 ">
