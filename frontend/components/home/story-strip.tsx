        ...
        {isLoading
          ...
          : data.map((story, index) => (
              <button
                ...
                className="neo-card group min-h-36 min-w-32 rounded-[2rem] p-2 text-right transition hover:-translate-y-1"
              >
                <div className="relative h-24 overflow-hidden rounded-[1.5rem] bg-black">
                  ...
                  <div className="absolute right-2 top-2 grid h-7 w-7 place-items-center rounded-full bg-black/50 backdrop-blur-xl">
                    <Camera size={13} />
                  </div>
                </div>
