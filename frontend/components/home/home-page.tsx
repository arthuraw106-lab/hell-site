...
export function HomePage() {
 ...
 loading="lazy"
 />
 <div className="absolute inset-0 bg-gradient-to-t from-hell-bg via-hell-bg to-transparent" />
 ...
 loading="lazy"
 />
 <div className="absolute right-2 top-2 rounded-md bg-hell-bg px-2 py-0.5 text-[10px] font-bold">{m.status}</div>
 </div>
 <div className="p-2">
