...
export function HomeMangaCard({ manga, index = 0 }: { manga: Manga; index?: number }) {
 ...
 <article className="card h-full rounded-[2rem] transition duration-500 hover:-translate-y-2 hover:">
 ...
 <div className="p-5">
 <h3 className="text-xl font-black transition group-hover:text-hell-light">{manga.title}</h3>
 ...
 <Heart size={13} className="text-hell-violet" />
 {manga._count?.likes || 0}
 </span>
 <span className="flex items-center gap-1">
 <Star size={13} className="text-hell-light" />
